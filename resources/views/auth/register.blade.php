...
@section('content')
<div class="authentication-wrapper authentication-cover bg-primary">
  <!-- Logo -->
  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-12 px-12 py-6">
      <div class="w-px-400 mx-auto pt-5 pt-lg-0">
        <h4 class="mb-1">AquaBill</h4>
        <p class="mb-5">Welcome to the SSUWC!</p>
        ...
        <form id="formAuthentication" class="mb-5" action="{{ route('register') }}" method="POST">
          ...
          <div class="form-floating form-floating-outline mb-5">
            <input type="text" class="form-control @error('role') is-invalid @enderror" id="role" name="role" placeholder="john@example.com" value="{{ old('role') }}">
